...
from packages.yolo3.tinymodel import yolo_eval, yolo_body, tiny_yolo_body
from packages.yolo3.utils import letterbox_image
import time
...
class YOLO(object):
    _defaults = {
        ...
        "anchors_path": './config/anchors.txt',
...
if __name__ == '__main__':
    ...
    for i in range(100, 101):
        image = Image.open("E:/Database/mall_dataset/frames/seq_000" + str(i) + ".jpg")
